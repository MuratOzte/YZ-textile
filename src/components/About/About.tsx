                        ...
                        {isAboutInView && (
                            <div>
                                <div className="w-full flex justify-center items-center gap-5">
                                    ...
                                    >
                                        We produce high quality clothing with
                                        our vision and understanding of
                                ...
                                <div className="w-full flex justify-center items-center gap-5">
                                    ...
                                    >
                                        ...
                                        <p>
                                            ...
                                            sweatpants, tracksuits and t-shirts
                                ...
                                <div className="w-full flex justify-center items-center gap-5 mt-16 ">
                                    ...
                                    >
                                        ...
                                        <p>
                                            ...
                                            Our seasoned team oversees every
                                            stage from pre-production through to
                                            post-production, ensuring seamless
                                            support and efficiency, so you can
                                            streamline your operations without
                                            the hassle of multiple suppliers for
                                            each step.
                                        </p>
                                    </motion.p>
                                </div>
